 ...
 */
static PyObject *Announcement_from_yaml_dict(PyObject *cls, PyObject *args) {
    PyObject *dct = NULL;
    PyObject *yaml_tag = NULL;
    if (!PyArg_ParseTuple(args, "OO", &dct, &yaml_tag)) {
        return NULL;
    }
...
static PyMethodDef Announcement_methods[] = {
    ...
    {"__from_yaml_dict__", (PyCFunction)Announcement_from_yaml_dict, METH_VARARGS | METH_CLASS, "yaml.load helper"},
